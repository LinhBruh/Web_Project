<?php
    $query = "SELECT * FROM congty_congviec AS c JOIN cong_ty AS cty ON c.maCongTy = cty.maCongTy JOIN cong_viec AS cv ON c.maCongViec = cv.maCongViec WHERE cv.maDanhMuc = '$_GET[id]'";
